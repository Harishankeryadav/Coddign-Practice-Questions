...
int main()
{
    ...
    h.insert(1234253403, "h");
    h.insert(1234753408, "i");
    h.insert(1534253400, "g");
    h.insert(1234253400, "j");
    h.insert(1234254401, "k");

    cout << h.search(1234254401) << endl;
    h.print();
    h.remove(1234254401);
    h.print();
    cout << h.search(1004254401) << endl;
